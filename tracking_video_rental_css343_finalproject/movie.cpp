...
// Purpose: A source file for Movie class.
//
//          This source file for movie will write all the necessary
//	    function used to store the movie information declared on a header.
//
