...
// Purpose: A header file for Movie class.
//
//          This header file for movie will declare all the necessary
//	    function used to store the movie information.
//	    This header will also declare a private variable to be used,
//	    and getter/setter for each of the variables.
//
//	    There are 3 classes, Drama, Comedy and Classical that will
